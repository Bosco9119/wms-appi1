...
class ShopDataPopulator {
  ...
  Future<void> populateSampleData() async {
    try {
      ...
      print(
        '🎉 ShopDataPopulator: Successfully populated ${sampleShops.length} shops',
      );
    } catch (e) {
  ...
  List<Shop> _getSampleShops() {
    ...
    return [
      Shop(
        ...
        description:
            'We have more than 25 years experiences on servicing & repairing engines, transmission, suspension with the latest technology troubleshooting devices from UK. Our team of certified mechanics ensures your vehicle gets the best care possible.',
      ...
      Shop(
        ...
        description:
            'Professional automotive repair and maintenance services. Specializing in European and Japanese vehicles with state-of-the-art diagnostic equipment.',
      ...
      Shop(
        ...
        description:
            'Fast and reliable auto repair services. We specialize in quick fixes and routine maintenance to get you back on the road quickly.',
      ...
      Shop(
        ...
        description:
            'Luxury and high-performance vehicle specialists. We work on premium brands and provide top-tier service with genuine parts.',
      ...
      Shop(
        ...
        description:
            'Affordable auto repair services without compromising quality. We provide honest pricing and reliable service for all vehicle types.',
      ...
      Shop(
        ...
        description:
            'Round-the-clock emergency auto repair services. We are always available when you need us most, day or night.',
